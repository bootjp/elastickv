...
// should run the cluster with ELASTICKV_REDIS_PER_PEER_CONNECTIONS at least as
// high as this pool size; lower the proxy pool instead for clusters that keep
// the server-side per-peer cap below the default.
