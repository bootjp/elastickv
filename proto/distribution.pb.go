...
type GetRouteResponse struct {
	...
	RaftGroupId   uint64 `protobuf:"varint,2,opt,name=raft_group_id,json=raftGroupId,proto3" json:"raft_group_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_distribution_proto_rawDesc = "" +
	...
	"\rraft_group_id\x18\x02 \x01(\x04R\vraftGroupId\"\x15\n" +
