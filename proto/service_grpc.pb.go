...
func (c *raftAdminClient) Status(ctx context.Context, in *RaftAdminStatusRequest, opts ...grpc.CallOption) (*RaftAdminStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RaftAdminStatusResponse)
	err := c.cc.Invoke(ctx, RaftAdmin_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftAdminClient) Configuration(ctx context.Context, in *RaftAdminConfigurationRequest, opts ...grpc.CallOption) (*RaftAdminConfigurationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RaftAdminConfigurationResponse)
	err := c.cc.Invoke(ctx, RaftAdmin_Configuration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftAdminClient) AddVoter(ctx context.Context, in *RaftAdminAddVoterRequest, opts ...grpc.CallOption) (*RaftAdminConfigurationChangeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *raftAdminClient) TransferLeadership(ctx context.Context, in *RaftAdminTransferLeadershipRequest, opts ...grpc.CallOption) (*RaftAdminTransferLeadershipResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RaftAdminTransferLeadershipResponse)
...
func _RaftAdmin_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RaftAdminStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftAdminServer).Status(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftAdmin_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftAdminServer).Status(ctx, req.(*RaftAdminStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RaftAdmin_Configuration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RaftAdminConfigurationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftAdminServer).Configuration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftAdmin_Configuration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftAdminServer).Configuration(ctx, req.(*RaftAdminConfigurationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RaftAdmin_AddVoter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RaftAdminAddVoterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftAdminServer).AddVoter(ctx, req.(*RaftAdminAddVoterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RaftAdmin_RemoveServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftAdminServer).RemoveServer(ctx, req.(*RaftAdminRemoveServerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RaftAdmin_TransferLeadership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RaftAdminTransferLeadershipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftAdminServer).TransferLeadership(ctx, req.(*RaftAdminTransferLeadershipRequest))
	}
	return interceptor(ctx, in, info, handler)
}
