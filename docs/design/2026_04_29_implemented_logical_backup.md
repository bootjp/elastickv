...
`SnapshotEvery = 100000` (`defaultSnapshotEvery`,
`internal/raftengine/etcd/engine.go`) and
`--backupSnapshotHeadroomEntries = 1000` (`defaultBackupHeadroom`,
`main.go`), the check refuses backups when fewer than 1000 entries
